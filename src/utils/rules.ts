...
export const rules: Rule[] = [
  ...
  { name: "清幺九", check: checkRule8, score: 64, excludeOtherRules: [] },
  { name: "小四喜", check: checkRule9, score: 64, excludeOtherRules: [] },
  { name: "小三元", check: checkRule10, score: 64, excludeOtherRules: [] },
  { name: "字一色", check: checkRule11, score: 64, excludeOtherRules: [] },
  { name: "四暗刻", check: checkRule12, score: 64, excludeOtherRules: [] },
  { name: "一色双龙会", check: checkRule13, score: 64, excludeOtherRules: [] },
  { name: "一色四同顺", check: checkRule14, score: 48, excludeOtherRules: [] },
  { name: "一色四节高", check: checkRule15, score: 48, excludeOtherRules: [] },
  { name: "一色四步高", check: checkRule16, score: 32, excludeOtherRules: [] },
  { name: "三杠", check: checkRule17, score: 32, excludeOtherRules: [] },
  { name: "混幺九", check: checkRule18, score: 32, excludeOtherRules: [] },
  { name: "七对", check: checkRule19, score: 24, excludeOtherRules: [] },
  { name: "七星不靠", check: checkRule20, score: 24, excludeOtherRules: [] },
  { name: "全双刻", check: checkRule21, score: 24, excludeOtherRules: [] },
  { name: "清一色", check: checkRule22, score: 24, excludeOtherRules: [] },
  { name: "一色三同顺", check: checkRule23, score: 24, excludeOtherRules: [] },
  { name: "一色三节高", check: checkRule24, score: 24, excludeOtherRules: [] },
  { name: "全大", check: checkRule25, score: 24, excludeOtherRules: [] },
  { name: "全中", check: checkRule26, score: 24, excludeOtherRules: [] },
  { name: "全小", check: checkRule27, score: 24, excludeOtherRules: [] },
  { name: "清龙", check: checkRule28, score: 16, excludeOtherRules: [] },
  { name: "三色双龙会", check: checkRule29, score: 16, excludeOtherRules: [] },
  { name: "一色三步高", check: checkRule30, score: 16, excludeOtherRules: [] },
  { name: "全带五", check: checkRule31, score: 16, excludeOtherRules: [] },
  { name: "三同刻", check: checkRule32, score: 16, excludeOtherRules: [] },
  { name: "三暗刻", check: checkRule33, score: 16, excludeOtherRules: [] },
  { name: "全不靠", check: checkRule34, score: 12, excludeOtherRules: [] },
  { name: "组合龙", check: checkRule35, score: 12, excludeOtherRules: [] },
  { name: "大于五", check: checkRule36, score: 12, excludeOtherRules: [] },
  { name: "小于五", check: checkRule37, score: 12, excludeOtherRules: [] },
  { name: "三风刻", check: checkRule38, score: 12, excludeOtherRules: [] },
  { name: "花龙", check: checkRule39, score: 8, excludeOtherRules: [] },
  { name: "推不倒", check: checkRule40, score: 8, excludeOtherRules: [] },
  { name: "三色三同顺", check: checkRule41, score: 8, excludeOtherRules: [] },
  { name: "三色三节高", check: checkRule42, score: 8, excludeOtherRules: [] },
  { name: "无番和", check: checkRule43, score: 8, excludeOtherRules: [] },
  { name: "妙手回春", check: checkRule44, score: 8, excludeOtherRules: [] },
  { name: "海底捞月", check: checkRule45, score: 8, excludeOtherRules: [] },
  { name: "杠上开花", check: checkRule46, score: 8, excludeOtherRules: [] },
  { name: "抢杠和", check: checkRule47, score: 8, excludeOtherRules: [] },
  ...
  { name: "全求人", check: checkRule52, score: 6, excludeOtherRules: [] },
  { name: "双暗杠", check: checkRule53, score: 6, excludeOtherRules: [] },
  { name: "双箭刻", check: checkRule54, score: 6, excludeOtherRules: [] },
  { name: "全带幺", check: checkRule55, score: 4, excludeOtherRules: [] },
  { name: "不求人", check: checkRule56, score: 4, excludeOtherRules: [] },
  { name: "双明杠", check: checkRule57, score: 4, excludeOtherRules: [] },
  { name: "和绝张", check: checkRule58, score: 4, excludeOtherRules: [] },
  { name: "箭刻", check: checkRule59, score: 2, excludeOtherRules: [] },
  { name: "圈风刻", check: checkRule60, score: 2, excludeOtherRules: [] },
  { name: "门风刻", check: checkRule61, score: 2, excludeOtherRules: [] },
  { name: "门前清", check: checkRule62, score: 2, excludeOtherRules: [] },
  { name: "平和", check: checkRule63, score: 2, excludeOtherRules: [] },
  ...
  { name: "断幺", check: checkRule68, score: 2, excludeOtherRules: [] },
